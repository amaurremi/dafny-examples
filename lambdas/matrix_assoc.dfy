...
lemma Same(a: Matrix, b: Matrix)
    requires forall x, y :: a(x)(y) == b(x)(y)
    ensures a == b
{
...
/** (a * (b * c))(i, j) == ((a * b) * c)(i, j) */
lemma mult_assoc_ij(a: Matrix, b: Matrix, c: Matrix, i: Index, j: Index)
    ensures mult(mult(a, b), c)(i)(j) == mult(a, mult(b, c))(i)(j)
{
    calc {
        ...
        == {
             assert forall k : Index :: mult(a, b)(i)(k)
                                 ==
                                 Sum((l: Index) => a(i)(l) * b(l)(k));
